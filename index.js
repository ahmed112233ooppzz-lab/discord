AHHonst Discord = require('discord.js-selfbot-v13');
...
client.on('ready', async () => {
  ...
  const r = new Discord.RichPresence()
    ...
    .setType('PLAYING')
    .setURL('https://youtu.be/NJBLQb3_YVA?si=Vn7C44ijBbQbWaW3') 
    .setState('A is here')
    .setName('quaaxz')
    .setDetails(`Ah`)
    .setStartTimestamp(Date.now())
 .setAssetsLargeImage('https://discord.com/channels/@me/1376090308017651884/1425214132910559240') //You can put links in tenor or discord and etc.
